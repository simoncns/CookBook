...
/**
 * Resource bundle for getting the Strings from the English properties file.
 * 
 * @author Max Adams
 * @version S2
 */
...
{
  private static final String BUNDLE_NAME = "Strings_en_US"; // The name of your property file
