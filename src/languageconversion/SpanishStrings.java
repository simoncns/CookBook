...
/**
 * Resource bundle for getting the Strings from the Spanish properties file.
 * 
 * @author Max Adams
 * @version S2
 */
public class SpanishStrings
{

  private static final String BUNDLE_NAME = "Strings_es_ES"; // The name of your property file
